...
<head>
	...
	<title>CCS Days - Export Data</title>
...
<body class="bg-dark-1 text-light">
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			...
			<a href="export.php" class="sidebar-link active">
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 icon">
	...
	<div class="main-content">
		...
		<div class="dashboard-container">
			...
			<!-- Export Data Navbar -->
			<?php include '../includes/export_navbar.php'; ?>
			
			<!-- Export Information Section -->
			<div class="export-info-section">
				<div class="info-card">
					<div class="info-header">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-teal-light">
							<path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
						</svg>
						<h2>Export Information</h2>
					</div>
					<div class="info-content">
						<p>Use the export tools above to download your data in PDF or Excel format. You can filter by data type and date range to get exactly what you need.</p>
						<ul class="info-list">
							<li><strong>PDF Export:</strong> Perfect for reports and presentations</li>
							<li><strong>Excel Export:</strong> Ideal for data analysis</li>
							<li><strong>Data Types:</strong> Students, Events, Attendance records</li>
							<li><strong>Date Filtering:</strong> Choose specific time periods</li>
						</ul>
					</div>
				</div>
			</div>
