...
<body class="bg-dark-1 text-light">
    ...
    <div class="sidebar">
        ...
        <div class="dashboard-container">
            ...
            <!-- Action Buttons -->
            <div class="flex gap-4 mb-6">
                <button id="createEventBtn" class="cursor-pointer action-button bg-teal-light text-dark-1 hover:bg-teal-dark transition-all flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                    Create Event
            ...
            <div class="modal-container bg-dark-2 w-11/12 md:max-w-md mx-auto rounded-lg shadow-2xl z-50 overflow-y-auto transform transition-all">
                <div class="modal-content py-4 text-left px-6">
                    ...
                    <form id="createEventForm">
                        ...
                        <!-- NEW: Sign-in Time Window -->
                        <div class="mb-4">
                            <label class="block text-light text-sm font-bold mb-2">Sign-in Time Window</label>
                            <div class="flex items-center space-x-2">
                                <input class="bg-dark-1 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-light leading-tight focus:outline-none focus:border-teal-light"
                                    id="signinStart" name="signinStart" type="time" placeholder="Start time" value="07:30">
                                <span class="text-gray-400">to</span>
                                <input class="bg-dark-1 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-light leading-tight focus:outline-none focus:border-teal-light"
                                    id="signinEnd" name="signinEnd" type="time" placeholder="End time" value="08:00">
                            </div>
                        </div>

                        <!-- NEW: Sign-out Time Window -->
                        <div class="mb-4">
                            <label class="block text-light text-sm font-bold mb-2">Sign-out Time Window</label>
                            <div class="flex items-center space-x-2">
                                <input class="bg-dark-1 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-light leading-tight focus:outline-none focus:border-teal-light"
                                    id="signoutStart" name="signoutStart" type="time" placeholder="Start time" value="12:00">
                                <span class="text-gray-400">to</span>
                                <input class="bg-dark-1 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-light leading-tight focus:outline-none focus:border-teal-light"
                                    id="signoutEnd" name="signoutEnd" type="time" placeholder="End time" value="12:30">
                            </div>
                        </div>
